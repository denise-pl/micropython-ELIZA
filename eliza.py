...
class Chatbot:
    ...
    def __init__(self, name=DEFAULT_NAME, data=script, logger=None):
        self._name = name
        ...
        """
        self._logger = logger
        """Handler for passing log messages
        """
...
def create(name=DEFAULT_NAME, logger=None):
    """Returns default agent object"""
    return Chatbot(name, script, logger=logger)
